...
export default function Home() {
  return (
    ...
    <div className="pt-16 px-2 min-[821px]:w-1/2 min-[821px]:ml-64 max-[820px]:w-full max-[820px]:px-5 z-0">
      <Search></Search>
      <ul className="pt-4 bg-white grid grid-cols-3 gap-4 justify-stretch">
        <Link href="/scholar">
        <li className="p-1 rounded border-2 border-gray grid justify-items-center hover:bg-gray-light">
