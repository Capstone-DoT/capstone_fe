    ...
    return (
        <>
            ...
            <div className='pl-5 pt-5 absolute top-14 right-0 w-[33%] h-screen'>
                <div className='mb-8'>
                    <span className='ml-2 p-2 text-white text-lg font-extrabold border-2 bg-orange rounded-xl'>AI 추천</span><span className='ml-4 font-bold text-xl'>이 대외활동 어떠세요?</span>
                </div>
                <List></List>
            </div>
        </>
