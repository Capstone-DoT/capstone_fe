...
export default function search() {
    return(
      ...
      <div className="pt-16 px-2 min-[821px]:w-1/2 min-[821px]:ml-64 max-[820px]:w-full max-[820px]:px-5 z-0">
          <h1 className="font-bold text-2xl text-black mb-2">검색</h1>
          <Search></Search>
          <h1 className="mt-6 mb-2 text-lg font-bold text-black">Do.T 추천검색어</h1>
          ...
          <h1 className="mt-6 mb-2 text-lg font-bold text-black">Do.T 인기검색어</h1>
