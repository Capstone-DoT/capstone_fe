export default function searchbar() {
    ...
    <form>   
        <div className="relative">
            ...
            <input id="default-search" className="pl-14 block h-15 w-full p-4 pl-10 text-sm text-gray-900  placeholder-[#9CA3AF] border-2 ring-[#FFA12E] border border-[#FFA12E]" placeholder="찾고 싶은 정보를 검색해보세요 !" required>
            </input>
        </div>
    </form>
